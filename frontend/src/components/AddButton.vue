  ...
  <div v-if="isAuthenticated">
    <div class="group fixed bottom-3 right-4">
      ...
      <div class="relative p-3 flex items-end justify-end">
        ...
        <!-- Add Group Button -->
        <div class="absolute rounded-full transition-all duration-200 ease-out scale-y-0 group-hover:scale-y-100 group-hover:-translate-x-20 flex items-center justify-center p-4 hover:p-4 bg-[#B03052] hover:bg-[#3D0301] text-white h-16 w-16">
